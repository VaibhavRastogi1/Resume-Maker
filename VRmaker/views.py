...
class ResumeForm(View):
        ...
        def get(self,request):
            if request.user.is_authenticated:
                ...
                print(user_id)
                data=Filldetails.objects.filter(user_id=user_id)
                print(data)
        ...
        def post(self,request):
                ...
                Filldetails.objects.create(name=name,dob=dob,email=email,gender=gender,locality=locality,city=city,pincode=pincode,state=state,contact=contact,preferredJL=preferredJL,image=image,user_id=request.user)
...
class Showup(View):
    def get(self,request,id):
        candidate=Filldetails.objects.filter(pk=id)
